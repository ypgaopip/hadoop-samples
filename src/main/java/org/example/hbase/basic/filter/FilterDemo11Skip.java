...
public class FilterDemo11Skip {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Scan scan = new Scan();
        //筛选特定值满足条件单元格
        ValueFilter filter = new ValueFilter(CompareFilter.CompareOp.NOT_EQUAL, new SubstringComparator("lucy"));
        //如果发现一行中的某一列不符合条件，那么整行就会被过滤掉
        SkipFilter filter2 = new SkipFilter(filter);
