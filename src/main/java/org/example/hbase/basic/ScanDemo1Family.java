...
public class ScanDemo1Family {
    ...
    public static ResultScanner scan(String tableName, String rowKey, String family) throws IOException {
        createConnection();
        Table table = connection.getTable(TableName.valueOf(tableName));
        Scan scan = new Scan(family.getBytes());
    ...
    public static void main(String[] args) throws IOException {
        ...
        ResultScanner scan = scan("stu2", "rw001", "info");
